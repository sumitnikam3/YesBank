...
import hemendra from "../assets/hemendra.jpeg";
    ...
    <section className="section-white">
      <div className="container">
        <div className="row">
          ...
          <div className="col-sm-6 col-md-4">
            <div className="team-item flex flex-col items-center">
              <img src={sumit} className="team-img " alt="Sumit" />
              <h3>Sumit Nikam</h3>
              <div className="team-info">
                <p className="font-semibold">012 Kharghar</p>
                <p>
                Sumit specializes in end-to-end development. His training at CDAC has equipped him with the latest skills. In his free time, Sumit is an avid reader of non-fiction books and enjoys exploring new technologies.
                </p>

                <div className=" flex items-center gap-2 w-fit mx-auto my-5">
                  <div className="w-10 h-10">
                    <a
                      href="https://www.linkedin.com/in/sumit-nikam-a41298212/"
                      target="_blank"
                      className="w-full h-full flex items-center justify-center"
                    >
                      <svg
                  ...
                  <div className="w-10 h-10">
                    <a href="mailto:sumitnikamofficial@gmail.com" target="_blank">
                      <svg
                        viewBox="0 0 32 32"
                        fill="none"
                        xmlns="http://www.w3.org/2000/svg"
                  ...
                  <div className="w-10 h-10">
                    <a href="https://wa.me/9579402011" target="_blank">
                      <img src={WhatsApp} alt="" />
                    </a>
                  </div>
                </div>
          ...
          <div className="col-sm-6 col-md-4">
            <div className="team-item flex flex-col items-center">
              <img src={hemendra} className="team-img" alt="pic" />
              <h3>Hemendra Mahajan</h3>
              <div className="team-info">
                <p className="font-semibold">004 Juhu</p>
                <p>
                Hemendra is an integral part of our team. His coursework at CDAC has enhanced his expertise in various technologies. When he's not coding, Hemendra enjoys solving complex puzzles and playing chess
                </p>

                <div className=" flex items-center gap-2 w-fit mx-auto my-5">
                  <div className="w-10 h-10">
                    <a
                      href="https://www.linkedin.com/in/hemendra-mahajan-903827208"
                      target="_blank"
                      className="w-full h-full flex items-center justify-center"
                    >
                      <svg
                  ...
                  <div className="w-10 h-10">
                    <a href="mailto:hemendramaha1024@gmail.com" target="_blank">
                      <svg
                        viewBox="0 0 32 32"
                        fill="none"
                        xmlns="http://www.w3.org/2000/svg"
                  ...
                  <div className="w-10 h-10">
                    <a href="https://wa.me/9158303740" target="_blank">
                      <img src={WhatsApp} alt="" />
                    </a>
                  </div>
                </div>
